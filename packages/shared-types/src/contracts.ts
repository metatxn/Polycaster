...
/**
 * NegRiskCtfCollateralAdapter — pUSD collateral adapter for neg-risk markets.
 * This is the current Neg Risk Adapter for CLOB v2; the v1 adapter
 * (0xd91E80cF2E7be2e162c6513ceD06f1dD0dA35296) was retired 2026-07-17.
 */
...
/** Polymarket Deposit Wallet Beacon */
export const DEPOSIT_WALLET_BEACON_ADDRESS =
...
export const CONTRACTS = {
  ...
  DEPOSIT_WALLET_BEACON: DEPOSIT_WALLET_BEACON_ADDRESS,
} as const;
