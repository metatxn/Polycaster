 ...
 * NEXT_PUBLIC_POLYMARKET_HOST with a fallback to the canonical V2 host.
 * Post-cutover (2026-04-28) the primary host serves V2; the legacy
 * `clob-v2.polymarket.com` alias still resolves but should not be used.
 */
