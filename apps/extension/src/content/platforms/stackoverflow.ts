...
function findStackOverflowInjectionPoint(
  postElement: Element
): InjectionPoint | null {
...
const StackOverflowAdapter = createBasicAdapter({
  name: "stackoverflow",
  hostPatterns: [/^(?:meta\.)?stackoverflow\.com$/],
  ...
  borderRadius: "10px",
  findInjectionPoint: findStackOverflowInjectionPoint,
