/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./cloudflare-env.d.ts` (hash: 6d29fc22108e95fd7103afb241ad36d5)
// Runtime types generated with workerd@1.20260811.1 2026-07-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	MCP_AUTH_MODE: "dev-bypass" | "oauth-required";
	MCP_ALLOWED_HOSTNAMES: "localhost,127.0.0.1" | "mcp.knoww.app";
	MCP_ALLOWED_ORIGIN_HOSTNAMES: "localhost,127.0.0.1" | "knoww.app,www.knoww.app";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_AUTH_MODE" | "MCP_ALLOWED_HOSTNAMES" | "MCP_ALLOWED_ORIGIN_HOSTNAMES">> {}
}
