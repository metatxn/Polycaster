...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    `script-src 'self' 'unsafe-inline' https://us-assets.i.posthog.com${process.env.NODE_ENV === "development" ? " 'unsafe-eval'" : ""}`,
